...
7. **メール送信**
    ...
    - URL 例: `http://localhost:8080/BackDesk/admin/password_reset/form?token=xxx`
    - ロール別にメール件名・内容が異なる
...
-   **開発環境 URL**: http://localhost:8080/BackDesk
-   **本番環境 URL**: https://ourdesk.n-learning.jp/BackDesk
