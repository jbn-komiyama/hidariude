...
<%@ include file="/WEB-INF/jsp/_parts/admin/navbar.jspf" %>
	<div class="container py-4">
		...
		<div class="card shadow-sm">
			<div class="card-body">
				<fmt:formatNumber value="${taskRank.basePayCustomer}"
					maxFractionDigits="0" groupingUsed="false"
					var="basePayCustomerHidden" />
				<fmt:formatNumber value="${taskRank.basePaySecretary}"
					maxFractionDigits="0" groupingUsed="false"
					var="basePaySecretaryHidden" />
				<form method="post"
					action="<%=request.getContextPath()%>/admin/assignment/pm_register_check">
					<div class="row g-3">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<label class="form-label">対象月</label> <input type="month"
								class="form-control" name="targetYM" id="targetYM"
								value="${targetYM}" required>
						</div>
						<div class="col-md-6">
							<label class="form-label">PM秘書</label> <select
								class="form-select" name="secretaryId" id="secretaryId" required>
						...
						<div class="col-md-3">
							...
							<input type="hidden" name="basePayCustomer"
								value="${basePayCustomerHidden}">
						</div>
						<div class="col-md-3">
							...
							<input type="hidden" name="basePaySecretary"
								value="${basePaySecretaryHidden}">
						</div>
						...
						<div class="col-12 text-end">
							...
							<a href="<%=request.getContextPath()%>/admin/assignment"
