...
<body class="bg-primary bg-opacity-10">
  ...
  <div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1 class="h4 text-primary mb-0">支出サマリー（秘書×月）</h1>
      <form class="d-flex gap-2" method="get" action="<%= request.getContextPath() %>/admin/summary/costs">
    ...
    <div class="card border-primary shadow-sm">
      <div class="card-header bg-primary text-white">
        会計年度：<strong>${fy}</strong>（${months[0]} ～ ${months[11]}）
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle mb-0 text-nowrap">
          <thead class="table-primary">
            <tr>
              <th style="min-width:220px;">秘書</th>
