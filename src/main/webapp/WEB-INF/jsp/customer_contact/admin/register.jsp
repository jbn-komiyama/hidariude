...
<body class="bg-primary bg-opacity-10">
  <div class="container py-4">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <form method="post" action="<%= request.getContextPath() %>/admin/customer/contact/register_check" class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="email" name="mail" class="form-control" value="${mail}" required> <!-- ★ CHANGED -->
          </div>
          <div class="col-md-6">
            <label class="form-label">初期パスワード <span class="text-danger">*</span></label>
            <input type="text" name="password" class="form-control" value="${password}" required> <!-- ★ CHANGED -->
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-check mt-4 pt-2">
              <input class="form-check-input" type="checkbox" name="isPrimary" value="true" id="isPrimary"
                     <c:if test="${isPrimary == 'true'}">checked</c:if>>
