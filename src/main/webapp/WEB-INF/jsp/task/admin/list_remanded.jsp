...
<div class="container py-4">
  ...
  <!-- フィルタ -->
  <form method="get" action="<%=request.getContextPath()%>/admin/task/list_remanded" class="card card-body shadow-sm mb-3">
              ...
              <tbody>
                <c:forEach var="t" items="${tasks}">
                  <tr>
                    ...
                    <td><fmt:formatDate value="${t.remandedAt}" pattern="yyyy-MM-dd HH:mm" timeZone="Asia/Tokyo"/></td>
