...
<body class="bg-primary bg-opacity-10">
	...
	<div class="container py-4">
		...
		<!-- フィルタ -->
		<form method="get"
			action="<%=request.getContextPath()%>/admin/task/list_approved"
		...
		<div class="card shadow-sm">
			<div
				...
				<form id="unapproveFormTop" class="m-0"
					onsubmit="document.getElementById('unapproveForm').requestSubmit(); return false;">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<form id="unapproveForm" method="post"
							action="<%=request.getContextPath()%>/admin/task/unapprove_bulk"
							class="m-0">
							<input type="hidden" name="yearMonth" value="${yearMonth}">
							<input type="hidden" name="sec" value="${sec}"> <input
