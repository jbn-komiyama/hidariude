...
<body class="bg-primary bg-opacity-10">
  ...
  <div class="container py-4">
    ...
    <div class="card shadow-sm mb-3">
      <div class="card-body">
        <dl class="row">
          ...
          <dd class="col-sm-9"><code><c:out value="${vId}"/></code></dd>
    ...
    <div class="d-flex gap-2">
      ...
      <!-- 確定：更新実行 -->
      <form method="post" action="<%= request.getContextPath() %>/admin/customer/edit_done" class="m-0">
