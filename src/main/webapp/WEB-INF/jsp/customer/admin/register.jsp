...
<body class="bg-primary bg-opacity-10">
  <div class="container py-4">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <form method="post" action="<%= request.getContextPath() %>/admin/customer/register_done">
          <div class="row g-3">

            <div class="col-md-4">
              <label class="form-label">会社コード</label>
              <input type="text" name="companyCode" class="form-control" value="${companyCode}">
            </div>
            ...
            <div class="col-md-3">
              ...
              <input type="text" name="postalCode" class="form-control" placeholder="ハイフンなし" value="${postalCode}">
            </div>
